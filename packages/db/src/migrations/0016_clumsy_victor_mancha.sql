...
ALTER TABLE "media" ADD COLUMN "scope_type" text NOT NULL DEFAULT 'personal';--> statement-breakpoint
ALTER TABLE "media" ADD COLUMN "scope_id" text NOT NULL DEFAULT '';--> statement-breakpoint
UPDATE "media" SET "scope_id" = "user_id" WHERE "scope_type" = 'personal';--> statement-breakpoint
ALTER TABLE "media" ALTER COLUMN "scope_type" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "media" ALTER COLUMN "scope_id" DROP DEFAULT;--> statement-breakpoint
